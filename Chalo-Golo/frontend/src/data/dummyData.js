...
export const dummyEvents = [
  {
    ...
    location: 'Hyderabad + Online', distance: 'Hybrid', desc: 'Build in 24hrs with any AI model. Prizes worth Rs. 2L. Perfect for beginners.',
    details: 'A beginner-friendly sprint where teams turn one practical AI idea into a working demo. Mentors help with product scope, prompting, UI polish, and final pitching.',
    entryCriteria: 'Students, beginners, builders, and solo participants are welcome. Teams can have 1-4 members.',
    rules: ['Bring your own laptop and charger.', 'Use only tools, datasets, and APIs you are allowed to use.', 'Submit a working demo link and a 2-minute pitch.', 'Respect team privacy and no plagiarism.'],
    schedule: ['Day 1 10:00 AM kickoff', 'Day 1 2:00 PM mentor check-in', 'Day 2 9:00 AM final build window', 'Day 2 4:00 PM demos and judging'],
  ...
  },
  {
    ...
    location: 'Banjara Hills, Hyderabad', distance: '7 km', desc: 'Monthly meetup for early-stage founders and aspiring entrepreneurs.',
    details: 'A practical founder circle focused on validating ideas, finding early users, and meeting collaborators before spending months building the wrong thing.',
    entryCriteria: 'Open to founders, students, indie builders, designers, and developers with an idea or early prototype.',
    rules: ['No hard selling during intro rounds.', 'Keep pitches under 60 seconds.', 'Share one ask and one thing you can help with.', 'Respect contact preferences after the event.'],
    schedule: ['5:30 PM check-in', '6:00 PM founder intros', '6:45 PM problem validation roundtables', '7:45 PM open networking'],
  ...
  },
  {
    ...
    location: 'Online (Discord)', distance: 'Online', desc: 'Weekend sprint contributing to real open-source projects. Mentors available.',
    details: 'A guided online sprint where learners pick beginner issues, set up repositories, make their first pull request, and get feedback from mentors.',
    entryCriteria: 'Anyone with basic GitHub access can join. No previous open-source contribution required.',
    rules: ['Follow project contribution guidelines.', 'Ask maintainers before taking large issues.', 'Keep comments respectful and specific.', 'One quality pull request beats five rushed ones.'],
    schedule: ['10:00 AM orientation', '11:00 AM issue picking', '2:00 PM mentor office hours', '6:00 PM PR review room'],
  ...
  },
  {
    ...
    location: 'Madhapur, Hyderabad', distance: '11 km', desc: 'Half-day workshop on design thinking methodology for product builders.',
    details: 'A hands-on workshop for turning vague product ideas into user journeys, pain points, wireframes, and a testable prototype plan.',
    entryCriteria: 'Open to designers, developers, product students, and founders. Bring one problem statement if you have one.',
    rules: ['Phones silent during interviews.', 'Do not record participants without consent.', 'Share critique on the work, not the person.', 'Leave with one testable prototype plan.'],
    schedule: ['9:30 AM warm-up', '10:00 AM user empathy mapping', '11:30 AM ideation sprint', '1:00 PM prototype critique'],
