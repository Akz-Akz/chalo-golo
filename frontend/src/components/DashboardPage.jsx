        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 13, color: '#3d3a36', lineHeight: 1.6, marginBottom: 16 }}>
              Add your Groq API key to get <strong>specific, real, tailored learning resources</strong> instead of generic platform links. When enabled, Pathfinder will ask AI to suggest the best courses, videos, and tutorials for your exact goal.
            </p>
            ...
            <p style={{ fontSize: 11, color: '#9c9589', lineHeight: 1.5, marginBottom: 16 }}>
              Your key is stored only in your browser's localStorage and is sent directly to Groq — never to Pathfinder servers. You can also set <code style={{ fontSize: 10 }}>VITE_GROQ_API_KEY</code> in <code style={{ fontSize: 10 }}>.env.local</code>. Get a key at <a href="https://console.groq.com/keys" target="_blank" rel="noreferrer" style={{ color: '#5b47e0', textDecoration: 'none', fontWeight: 600 }}>console.groq.com/keys</a>
            </p>
